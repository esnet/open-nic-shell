...
module box_250mhz #(
  ...
  output     [NUM_PHYS_FUNC*NUM_QDMA-1:0] m_axis_qdma_c2h_tuser_qid_valid,
  output  [12*NUM_PHYS_FUNC*NUM_QDMA-1:0] m_axis_qdma_c2h_tuser_qid,
  ...
  input      [NUM_CMAC_PORT-1:0] s_axis_adap_rx_250mhz_tuser_qid_valid,
  input   [12*NUM_CMAC_PORT-1:0] s_axis_adap_rx_250mhz_tuser_qid,
...
`endif
  ...
  generate if (USE_PHYS_FUNC == 0) begin
    ...
    assign m_axis_qdma_c2h_tuser_qid_valid = 0;

...
module qdma_subsystem #(
  ...
  input      [NUM_PHYS_FUNC-1:0] s_axis_c2h_tuser_qid_valid,
  input   [12*NUM_PHYS_FUNC-1:0] s_axis_c2h_tuser_qid,
  ...
  generate if (USE_PHYS_FUNC == 0) begin
    ...
    for (genvar i = 0; i < NUM_PHYS_FUNC; i++) begin
      qdma_subsystem_function #(
        ...
        .s_axis_c2h_tuser_qid_valid  (s_axis_c2h_tuser_qid_valid[i]),
        .s_axis_c2h_tuser_qid  (s_axis_c2h_tuser_qid[`getvec(12, i)]),

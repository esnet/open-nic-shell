...
`endif
  ...
  wire     [NUM_PHYS_FUNC*NUM_QDMA-1:0] axis_qdma_c2h_tuser_qid_valid;
  wire  [12*NUM_PHYS_FUNC*NUM_QDMA-1:0] axis_qdma_c2h_tuser_qid;
  ...
  wire     [NUM_CMAC_PORT-1:0] axis_adap_rx_250mhz_tuser_qid_valid;
  wire  [12*NUM_CMAC_PORT-1:0] axis_adap_rx_250mhz_tuser_qid;
  ...
  wire     [NUM_CMAC_PORT-1:0] axis_adap_rx_322mhz_tuser_qid_valid;
  wire  [12*NUM_CMAC_PORT-1:0] axis_adap_rx_322mhz_tuser_qid;
...
`endif
  ...
  generate for (genvar i = 0; i < NUM_CMAC_PORT; i++) begin: cmac_port
    packet_adapter #(
      ...
      .m_axis_rx_tuser_qid_valid (axis_adap_rx_250mhz_tuser_qid_valid[i]),
      .m_axis_rx_tuser_qid  (axis_adap_rx_250mhz_tuser_qid[`getvec(12, i)]),
      ...
      .s_axis_rx_tuser_qid_valid (axis_adap_rx_322mhz_tuser_qid_valid[i]),
      .s_axis_rx_tuser_qid  (axis_adap_rx_322mhz_tuser_qid[`getvec(12, i)]),
...
`endif
  ...
  box_250mhz #(
    ...
    .m_axis_qdma_c2h_tuser_qid_valid  (axis_qdma_c2h_tuser_qid_valid),
    ...
    .s_axis_adap_rx_250mhz_tuser_qid_valid (axis_adap_rx_250mhz_tuser_qid_valid),
    .s_axis_adap_rx_250mhz_tuser_qid  (axis_adap_rx_250mhz_tuser_qid),
  ...
  box_322mhz #(
    ...
    .m_axis_adap_rx_322mhz_tuser_qid_valid (axis_adap_rx_322mhz_tuser_qid_valid),
    .m_axis_adap_rx_322mhz_tuser_qid (axis_adap_rx_322mhz_tuser_qid),

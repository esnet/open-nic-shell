...
set_property -dict { 
    ...
    CONFIG.M08_A00_BASE_ADDR {0x0000000000020000}
    CONFIG.M09_A00_BASE_ADDR {0x0000000000040000}
    CONFIG.M10_A00_BASE_ADDR {0x0000000000080000}
    CONFIG.M11_A00_BASE_ADDR {0x0000000000200000}
    ...
    CONFIG.M10_A00_ADDR_WIDTH {19}
    CONFIG.M11_A00_ADDR_WIDTH {21}
